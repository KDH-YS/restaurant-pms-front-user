    ...
    <div className="container">
      <div className="content">
        ...
        <div className="js_shop_info">
          <img src="https://via.placeholder.com/648x400" alt="가게 이미지 1" />
          <img src="https://via.placeholder.com/648x400" alt="가게 이미지 2" />
        ...
        <div className="js_photo_review">
          ...
          {reviews.length > 0 ? (
            reviews.slice(0, showMoreReviews ? reviews.length : 4).map((review, index) => (
              <img key={index} src={review.imageUrl || "https://via.placeholder.com/324x324"} alt={`사진 리뷰 ${index + 1}`} />
            ))
          ) : (
            <p>사진 리뷰가 없습니다.</p>
          )}
            ...
            reviews.slice(0, showMoreReviews ? reviews.length : 3).map((review) => (
              <li key={review.reviewId}>
                <div>
                  ...
                  <img src={review.imageUrl || "https://via.placeholder.com/100x100"} alt="음식 이미지" />
